...
echo "📌 访问信息："
echo "   - Web 应用域名: https://${WEB_DOMAIN}"
echo "   - Web 前端上游: http://127.0.0.1:13000"
echo "   - Web 后端上游: http://127.0.0.1:18000"
echo "   - 邮件服务器: ${MAIL_SERVER}"
echo ""
echo "📌 重要提醒："
echo "   1. 确保 DNS 已正确配置指向此服务器"
echo "   2. 确保宿主机统一 Caddy 已加载 TalentMail 配置并反代到 127.0.0.1:13000 / 127.0.0.1:18000"
echo "   3. 确保防火墙已开放以下端口："
echo "      - 80, 443 (由宿主机统一 Caddy 占用)"
echo "      - 25, 587 (SMTP)"
echo "      - 143, 993 (IMAP)"
echo ""
echo "📌 常用命令："
