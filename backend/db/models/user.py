...
class SpamReport(Base):
    ...
    learn_attempts = Column(Integer, default=0, nullable=False, comment="训练尝试次数")
    learn_error = Column(String(1024), nullable=True, comment="最近一次训练失败信息")
    learned_at = Column(DateTime(timezone=True), nullable=True, comment="训练成功时间")
